...
Obsoletes:	owncloud-enterprise	<= 8.99.99
Obsoletes:	owncloud-enterprise-theme <= 8.99.99
Obsoletes:	owncloud-enterprise-app-files_antivirus	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-files_ldap_home	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-admin_audit	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-windows_network_drive	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-files_drop	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-files_sharing_log	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-enterprise_key	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-password_policy	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-user_shibboleth	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-firewall	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-sharepoint	<= 8.99.99
Obsoletes:	owncloud-enterprise-app-objectstore	<= 8.99.99
