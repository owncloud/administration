...
Obsoletes:	owncloud-enterprise	<= 9.01.99
Obsoletes:	owncloud-enterprise-theme <= 9.01.99
Obsoletes:	owncloud-enterprise-app-files_antivirus	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-files_ldap_home	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-admin_audit	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-windows_network_drive	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-files_drop	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-files_sharing_log	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-enterprise_key	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-password_policy	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-user_shibboleth	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-firewall	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-sharepoint	<= 9.01.99
Obsoletes:	owncloud-enterprise-app-objectstore	<= 9.01.99
