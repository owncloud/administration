...
class OC_Defaults {
	...
	function __construct($themeName) {
		// FIXME reenable l10n $this->l = \OC::$server->getL10N('lib');
		$version = array(8, 1, 0, 7);
		...
		// FIXME reenable l10n $this->defaultSlogan = $this->l->t('web services under your control');
		$this->defaultSlogan = 'web services under your control';
		$this->defaultLogoClaim = '';
		$this->defaultMailHeaderColor = '#1d2d44'; /* header color of mail notifications */

		$themePath = 'themes/' . $themeName . '/defaults.php';
